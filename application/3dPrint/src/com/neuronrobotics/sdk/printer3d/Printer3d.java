...
/** This Class was once for the purpose of representing the printer as
 * a java object, it has since be replaced and made obsolete by
 * the GCodeNR.java class found in the Neuron Robotics fork of the 
 * RepRap 3D printer software. Components of the 3D printer Eclipse
 * Project are being used by the new GCodeNR Class so it will remain
 * in the SVN for now until the projects merge*/
